  ...
  return (
    <Card>
      ...
      <ul className="list-disc pl-5 text-sm md:text-lg">
        ...
        <br />
        <li>
          <strong>Custom 3D Printing:</strong> Creating solutions for random
          issues people have, such as winch covers or whiteboard boats for
          sailing. Currently comfortable with just tinkerCAD but have been
          exploring Fusion.
        </li>
        <br />
        <li>
        ...
        <br />
        <li>
          <strong>President of RMIT Sailing:</strong> Founded and lead the RMIT
          Sailing Club since January 2024, fostering a vibrant community of
          sailing enthusiasts of any skill level.
        </li>
        <br />
        <li>
